...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference, defStyleAttr, defStyleRes);

        // The ordering of these two statements are important. If we want to set max first, we need
        // to perform the same steps by changing min/max to max/min as following:
        // mMax = a.getInt(...) and setMin(...).
        mMin = a.getInt(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_min, 0);
        setMax(a.getInt(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a.getInt(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_seekBarIncrement, 0));
        mAdjustable = a.getBoolean(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_adjustable, true);
        mShowSeekBarValue = a.getBoolean(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_showSeekBarValue, false);
        mUpdatesContinuously = a.getBoolean(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_updatesContinuously,
                false);

        int externalValuesResId = a.getResourceId(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_externalValues, 0);
        int externalValueStringResId = a.getResourceId(R.styleable.com_jonahbauer_qed_layoutStuff_SeekBarPreference_externalValueStrings, 0);
